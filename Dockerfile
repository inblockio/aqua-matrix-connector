...
#   <context>/
#     aqua-matrix-agent/      <- this repo (workspace root)
...
# resolve from within aqua-matrix-agent:
#   aqua-matrix-agent/Cargo.toml          siwx-oidc-auth = { path = "../siwx-oidc/siwx-oidc-auth" }
...
# (The build context root holds aqua-matrix-agent/, siwx-oidc/, aqua-auth/.)
COPY aqua-matrix-agent/ aqua-matrix-agent/
COPY siwx-oidc/         siwx-oidc/
COPY aqua-auth/         aqua-auth/

WORKDIR /build/aqua-matrix-agent
...
COPY --from=builder /build/aqua-matrix-agent/target/debug/aqua-matrix-claude-p /usr/local/bin/aqua-matrix-claude-p
COPY --from=builder /build/aqua-matrix-agent/target/debug/aqua-matrix-ask-mcp  /usr/local/bin/aqua-matrix-ask-mcp
